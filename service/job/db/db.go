...
func Prepare(ctx context.Context, db DBTX) (*Queries, error) {
	...
	if q.listJobStmt, err = db.PrepareContext(ctx, listJob); err != nil {
		return nil, fmt.Errorf("error preparing query ListJob: %w", err)
	}
...
func (q *Queries) Close() error {
	...
	if q.listJobStmt != nil {
		if cerr := q.listJobStmt.Close(); cerr != nil {
			err = fmt.Errorf("error closing listJobStmt: %w", cerr)
		}
	}
